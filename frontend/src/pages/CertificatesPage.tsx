import { FileBadge, ShieldSearch, Fingerprint } from 'lucide-react';
...
const tools = [
  ...
  { title: 'TLS Analyzer', description: 'Connect to a remote server and analyze its SSL/TLS certificate chain.', icon: ShieldSearch, path: '/certificates/tls' },
